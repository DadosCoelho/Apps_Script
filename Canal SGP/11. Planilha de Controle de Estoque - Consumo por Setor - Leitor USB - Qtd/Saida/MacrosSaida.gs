function FormSaida() {
  ...
  MostrarForm.setTitle("SAÍDAS").setHeight(600).setWidth(1100);

  SpreadsheetApp.getUi().showModalDialog(MostrarForm,"SAÍDAS");
...
function dadosBaixaSaida(){
  ...
  var dadosEntrada = guiaEntrada.getRange(2, 1, ultimaLinha, 4).getValues();  
