function onOpen(){
 ...
 .addItem('Setor', 'FormSetor')
 .addItem('Entradas', 'FormEntrada')
 .addItem('Saídas', 'FormSaida')
 .addItem('Filtro Entradas', 'FormFiltroEntrada') 
 .addItem('Filtro Saídas', 'FormFiltroSaida')  
 .addItem('Relatório de Estoque', 'FormRelatorio')
 .addItem('Relatório Consumo Setores', 'FormRelSetor')
 .addToUi();
}

var planilha = SpreadsheetApp.getActiveSpreadsheet();
var guiaProduto = planilha.getSheetByName("Produtos");
var guiaSetor = planilha.getSheetByName("Setores");
