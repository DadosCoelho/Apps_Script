...
function buscaDados(){  
  ...
  var dadosProdutos = guiaProduto.getRange(2, 1, ultimaLinha, 7).getValues();
  ...
  for(var i = 0; i < dadosSaida.length; i++){
    ...
    var DataValidade = Utilities.formatDate(new Date(dadosSaida[i][4]), planilha.getSpreadsheetTimeZone(),"dd/MM/yyyy");

    dadosSaida[i][4] = DataValidade;
