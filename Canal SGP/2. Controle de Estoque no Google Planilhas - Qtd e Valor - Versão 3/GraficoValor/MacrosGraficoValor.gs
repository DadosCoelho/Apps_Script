function FormGraficoValor() {
  ...
  var Form = HtmlService.createTemplateFromFile("GraficoValor");
  ...
  MostrarForm.setTitle("GRÁFICO VALOR").setHeight(600).setWidth(1100);

  SpreadsheetApp.getUi().showModalDialog(MostrarForm, "GRÁFICO VALOR");
